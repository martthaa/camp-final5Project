...
import {savaShippingAddress, saveShippingAdress} from '../slices/cartSlice';
...
const ShippingScreen = () => {
  ...
  return (
    <Modal className="login no-shadow" show={showModal} style={{border: 'none', backgroundColor: 'white'}}>
        <FormContainer>
